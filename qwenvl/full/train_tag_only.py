...
DEFAULT_CONFIG = {
    ...
    "output_dir": "/apdcephfs_gy2/share_302507476/xiaodayang/SpatialLogic/ckpt/qwenvl/full/tag_only",  # 输出目录
    "log_dir": "/apdcephfs_gy2/share_302507476/xiaodayang/SpatialLogic/log/tag_only",  # TensorBoard 日志目录
    "tag_files": [],  # TAG数据文件列表，用户必须通过命令行参数指定
    "epochs": 2,                    # 训练轮数
    "batch_size": 1,                # 批次大小（保持为1）
